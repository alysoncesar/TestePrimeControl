CT001 – Criar uma nova Conta com sucesso          X  
CT002 – Validar criação de uma conta com Email já cadastrado    X
CT003 – Realizar Login com sucesso         X                    
CT004 – Validar Login com senha inválida   X
CT005 – Realizar Cadastro de Clientes com sucesso na aba Perfil   x
CT006 – Validar Pesquisa de Cliente recém cadastrado e exibição dos dados em tela x
